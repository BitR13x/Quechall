...
const ProfileSettings = () => {
    ...
    const saveGenPrefs = () => {
        ...
        axios.post(VHOST + "/api/profile/editGenPrefs", {
            ...
            setGeneratePasswdPrefs({
                upperChars: checkedIUC, lowerChars: checkedILC, numbers: checkedIN,
    ...
    const handleChangeIS = (e: any) => setCheckedIS(e.target.checked);
    const handleChangeIN = (e: any) => setCheckedIN(e.target.checked);
    const handleChangeILC = (e: any) => setCheckedILC(e.target.checked);
    const handleChangeIUC = (e: any) => setCheckedIUC(e.target.checked);
